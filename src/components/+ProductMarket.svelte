<script>
	export let img = '/assets/placeholder/1.jpg';
...
<a
	class="cardContainer hover:bg-white hover:text-dark bg-[#303030] text-left rounded-xl grid text-white h-full min-h-96 w-full max-w-96"
	href="/info/1"
>
	<div
		class="image rounded-xl m-4 h-72 bg-center bg-no-repeat bg-cover"
		style="background-image:url({img}); align-self:normal;"
	></div>
...
<style>
	.cardContainer {
		...
		box-shadow: 0px 2px 14px 10px rgba(0, 0, 0, 0.6);
